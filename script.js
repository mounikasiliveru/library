const mainDiv =document.getElementById('flowers_library')
const flowers =[
      {
        "category": "Shrubs",
        "price": 15.99,
        ...
        "photo": "https://cdn.shopify.com/s/files/1/0717/3223/2497/files/Azalea_BenMorrison.jpg?v=1692546294",
        "name": "Azalea",
        "productId": 1
      },
      {
...
photo.src =flower.photo
photo.alt =flower.name
photo.textContent = flower.name
const btn =document.createElement('button') 
const anchor = document.createElement('a')
anchor.href =flower.photoLink;
anchor.target ="_blank"
anchor.textContent="Read more"
const category =document.createElement('category')
category.textContent =flower.category
flowerDiv.appendChild(name)
flowerDiv.appendChild(photo)
btn.appendChild(anchor)
flowerDiv.appendChild(btn)
flowerDiv.appendChild(category)
flowerDiv.classList.add('flower')
mainDiv.appendChild(flowerDiv)
})